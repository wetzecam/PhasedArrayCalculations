...
close all
subplot(2,2,2)
Dual_InterferePlot2(xQuad, yQuad, k, L, W);
title('Quad - Y ; Zero - X')

subplot(2,2,1)
Dual_InterferePlot2(xCirc, yCirc, k, L, W);
title('Lin - Y ; Zero - X')

subplot(2,2,3)
Dual_InterferePlot2(xCirc2, yCirc, k, L, W);
title('Lin - Y ; Circ - X')

subplot(2,2,4)
Dual_InterferePlot2(xCirc3, yCirc, k, L, W);
title('Quad - Y ; Circ - X')